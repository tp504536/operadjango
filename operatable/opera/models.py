...
class TimeLesson(models.Model):
    ...
    class Meta:
        verbose_name = "Дату"
        verbose_name_plural = "Уроки опера"
    def __str__(self):
        return self.day
class TableLesson(models.Model):
    room1 = models.CharField(null=False, max_length=20, verbose_name="Банцевич класс")
    time1 = models.TimeField(null=False, verbose_name='Время')
    title1 = models.CharField(null=True, max_length=20, verbose_name="Урок")
    room2 = models.CharField(null=False, max_length=20, verbose_name="Марков класс")
    time2 = models.TimeField(null=False, verbose_name='Время')
    title2 = models.CharField(null=True, max_length=20, verbose_name="Урок")
    room3 = models.CharField(null=False, max_length=20, verbose_name="Решетникова класс")
    time3 = models.TimeField(null=False, verbose_name='Время')
    title3 = models.CharField(null=True, max_length=20, verbose_name="Урок")
    room4 = models.CharField(null=False, max_length=20, verbose_name="Иванова класс")
    time4 = models.TimeField(null=False, verbose_name='Время')
    title4 = models.CharField(null=True, max_length=20, verbose_name="Урок")
    room5 = models.CharField(null=False, max_length=20, verbose_name="Смирнова класс")
    time5 = models.TimeField(null=False, verbose_name='Время')
    title5 = models.CharField(null=True, max_length=20, verbose_name="Урок")
    table = models.ForeignKey(TimeLesson, on_delete=models.CASCADE)

    class Meta:
        verbose_name_plural = "Преподователи класс время"

    def __str__(self):
        return self.room1
class OperaLesson(models.Model):
    users = (
    ...
    faml = models.CharField(null=False, max_length=15, verbose_name="фамилии", choices=users)
    teacher = models.CharField(null=False, max_length=20, verbose_name="Преподаватель", choices=prof)
    time = models.TimeField(null=False, verbose_name='Время')
    lesson = models.CharField(null=True, max_length=20, verbose_name="Урок")
    conductor = models.CharField(null=True, max_length=20, verbose_name="Дирижер")
    table = models.ForeignKey(TimeLesson, on_delete=models.CASCADE)
    class Meta:

        verbose_name_plural = "Рассписание по фамилии"
